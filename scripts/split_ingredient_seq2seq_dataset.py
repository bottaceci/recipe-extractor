...
def main(output_dir: Path) -> None:
    dataset_path = output_dir / "ingredient_seq2seq.jsonl"
    ...
    with open(output_dir / "ingredient_seq2seq_train.jsonl", 'w') as f:
        for record in train_records:
            f.write(json.dumps(record) + "\n")

    with open(output_dir / "ingredient_seq2seq_val.jsonl", 'w') as f:
        for record in val_records:
            f.write(json.dumps(record) + "\n")

    with open(output_dir / "ingredient_seq2seq_test.jsonl", 'w') as f:
